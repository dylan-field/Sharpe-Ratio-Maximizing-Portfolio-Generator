...
class PortfolioOptimizer:
    def __init__(self, start_date: str, end_date: str):
        ...
        self.cleaned_file_path = "C:/Users/dkaif/OneDrive/Desktop/DONT_TOUCH_O_P_Data/SP500_Adj_Close_Cleaned.csv"
        self.date_of_optimization = datetime.now().strftime("%Y-%m-%d")  # Set optimization date
